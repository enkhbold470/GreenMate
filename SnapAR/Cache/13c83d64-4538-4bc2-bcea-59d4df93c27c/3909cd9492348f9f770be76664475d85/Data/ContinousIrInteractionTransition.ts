...
implements IrInteractionTransition {
   ...
   */
    private computeMultiplier(handPoint: vec3,
        ...
        const effect = MathUtils.clamp(inverseLerp(-ContinousIrInteractionTransitionConfigDefault.minNeckHandDifference,
      ...
      ContinousIrInteractionTransitionConfigDefault.enableGazeControl
          ? MathUtils.clamp(inverseLerp(-ContinousIrInteractionTransitionConfigDefault.minGazePitchDegrees,
