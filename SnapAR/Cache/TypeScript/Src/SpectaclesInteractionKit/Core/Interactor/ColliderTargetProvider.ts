...
export abstract class ColliderTargetProvider extends TargetProvider {
  ...
  protected onColliderOverlapStay(event: OverlapEnterEventArgs,
      allowOutOfFovInteraction = true): void {
