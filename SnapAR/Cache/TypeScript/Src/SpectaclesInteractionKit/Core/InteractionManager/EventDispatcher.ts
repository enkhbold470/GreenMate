   ...
   */
    dispatch(eventArgs: DispatchableEventArgs): void {
      ...
      (eventArgs.target.hoveringInteractor & eventArgs.interactor.inputType) ===
        ...
        this.getInteractableAncestors(eventArgs.target.sceneObject.getParent(),
            ancestors,
    ...
    private getInteractableAncestors(node: SceneObject | null,
    ...
    private trickleDown(ancestors: Interactable[],
    ...
    private invokeEvent(event: InteractorEvent,
