...
vec3 l9_44=tempGlobals.ViewDirWS;
float l9_45=max(clamp(dot(l9_31,l9_44),0.0,1.0),9.9999997e-05);
float l9_46=l9_43*l9_43;
bool l9_47=l9_43<0.25;
float l9_48;
if (l9_47)
{
l9_48=(((-339.20001)*l9_46)+(161.39999*l9_43))-25.9;
}
else
{
l9_48=(((-8.4799995)*l9_46)+(14.3*l9_43))-9.9499998;
}
float l9_49;
if (l9_47)
{
l9_49=((44.0*l9_46)-(23.700001*l9_43))+3.26;
}
else
{
l9_49=((1.97*l9_46)-(3.27*l9_43))+0.72000003;
}
...
{
l9_52=0.1*(l9_43-0.25);
}
vec3 l9_53=N3_SheenOut.xyz+((((sampleSpecularEnvTextureLod(normalize(reflect(-l9_44,l9_31)),3.0+((((l9_43*4.0)-0.0)*2.0)/5.0))*sc_EnvmapExposure)+vec3(1e-06))*l9_35)*clamp((exp(l9_51)+l9_52)*3.1415927,0.0,1.0));
N3_SheenOut=vec4(l9_53.x,l9_53.y,l9_53.z,N3_SheenOut.w);
vec3 l9_54=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_32.xyz,vec3(l9_32.w));
...
float l9_65=clamp(dot(l9_31,l9_64),0.0,1.0);
l9_57=l9_56+(((((l9_62*3.1415901)*l9_35)*N3_charlieD(l9_46,clamp(dot(l9_31,normalize(l9_64+l9_44)),0.0,1.0)))*(1.0/(4.0*((l9_65+l9_45)-(l9_65*l9_45)))))*l9_65);
l9_56=l9_57;
l9_58++;
continue;
}
...
float l9_76=clamp(dot(l9_31,l9_75),0.0,1.0);
l9_68=l9_67+(((((l9_73*3.1415901)*l9_35)*N3_charlieD(l9_46,clamp(dot(l9_31,normalize(l9_75+l9_44)),0.0,1.0)))*(1.0/(4.0*((l9_76+l9_45)-(l9_76*l9_45)))))*l9_76);
l9_67=l9_68;
l9_69++;
continue;
}
...
l9_79=l9_78+(((l9_82*l9_83)/vec3(3.1415901))*l9_35);
l9_78=l9_79;
l9_80++;
continue;
}
...
#endif
N3_ClearcoatRoughness=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,l9_90,l9_89,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTexture).y);
}
