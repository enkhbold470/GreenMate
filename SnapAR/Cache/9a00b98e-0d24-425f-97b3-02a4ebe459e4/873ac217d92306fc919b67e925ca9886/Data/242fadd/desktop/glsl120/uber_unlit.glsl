...
#endif
l9_4=baseColor*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_6,l9_5,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
#else
{
l9_4=baseColor;
...
#if (ENABLE_RECOLOR)
{
vec3 l9_8=((recolorRed*l9_4.x)+(recolorGreen*l9_4.y))+(recolorBlue*l9_4.z);
l9_7=vec4(l9_8.x,l9_8.y,l9_8.z,l9_4.w);
}
#else
{
l9_7=l9_4;
...
{
vec2 l9_10=N7_getUV(NODE_69_DROPLIST_ITEM);
int l9_11;
...
#endif
l9_9=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_11,l9_10,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x;
}
#else
{
l9_9=1.0;
...
#endif
float l9_12=l9_9*l9_7.w;
vec4 l9_13;
float l9_14;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_14=l9_12*tempGlobals.VertexColor.w;
l9_13=l9_7*tempGlobals.VertexColor;
}
#else
{
l9_14=l9_12;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_16=N7_getUV(NODE_76_DROPLIST_ITEM);
int l9_17;
...
{
l9_18=l9_15+tempGlobals.VertexColor.xyz;
}
#else
{
l9_18=l9_15;
...
{
l9_19=ssPow((l9_18*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_19=l9_18;
...
#endif
vec3 l9_20=l9_13.xyz+ssPow((l9_19+vec3(0.0))+vec3(0.0),vec3(0.45454547));
...
{
l9_25=clamp(dot(l9_21.xyz,vec3(l9_14)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_21.xyz,vec3(0.33333001)))*l9_14;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0))*l9_14;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_30;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_21.xyz,vec3(0.33333001))*l9_14;
}
#else
{
float l9_33;
...
#endif
vec3 l9_45=mix(l9_43.xyz,definedBlend(l9_43.xyz,l9_21.xyz).xyz,vec3(l9_14));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_47=vec4(mix(vec3(1.0),l9_21.xyz,vec3(l9_14)),l9_14);
}
#else
{
vec4 l9_48;
