   ...
   */
    ...
    minimumSize: vec2 =
        this.targetWorldScaleCache.x > this.targetWorldScaleCache.y
            ...
            : new vec2((3 * this.targetWorldScaleCache.x) / this.targetWorldScaleCache.y,
                3);
    ...
    maximumSize: vec2 =
        this.targetWorldScaleCache.x > this.targetWorldScaleCache.y
            ...
            : new vec2((400 * this.targetWorldScaleCache.x) / this.targetWorldScaleCache.y,
                400);
      ...
      this.allowScaling
        ...
        if (!this.state.scaling || !this.state.translating) {
          ...
          inputState.drag.x * this.corner.x + inputState.drag.y * this.corner.y;
                ...
                let addScale: vec2 = new vec2(scaleAmount * this.scaleAmplifier,
                    scaleAmount * this.scaleAmplifier);

                addScale = addScale.mult(this.aspect);

                const newScale: vec2 = currentScale.add(addScale);
