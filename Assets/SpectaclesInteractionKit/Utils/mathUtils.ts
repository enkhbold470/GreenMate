 ...
 */
export function interpolateVec3(vectorA: vec3,
    vectorB: vec3,
    ratio: number): vec3 {
 ...
 */
export function mapValue(val: number,
    inMax: number,
    inMin: number,
    outMax: number,
    outMin: number): number {
 ...
 */
export function smoothDamp(current: number,
    target: number,
    velocity: number,
    smoothTime: number,
    deltaTime: number): [number, number] {
...
export function smoothDampAngle(current: number,
    target: number,
    velocity: number,
    smoothTime: number,
    deltaTime: number): [number, number] {
 ...
 * @returns the smoothened value and new velocity: [position, velocity]
 */
export function smoothSlide(current: number,
    velocity: number,
    smoothTime: number,
    deltaTime: number): [number, number] {
