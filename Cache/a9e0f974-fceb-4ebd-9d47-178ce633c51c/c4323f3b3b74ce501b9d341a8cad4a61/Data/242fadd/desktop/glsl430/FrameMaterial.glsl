...
{
l9_47=pow(l9_41,Port_Input1_N087);
}
vec4 l9_48=vec4(l9_47);
vec4 l9_49=max(l9_42,mix(Port_Input0_N024,Port_Input1_N024,l9_48));
float l9_50=borderAlpha*l9_41;
float l9_51;
if (l9_29<=0.0)
{
l9_51=0.0;
...
{
l9_51=pow(l9_29,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_52=(backingAlpha*Port_Input1_N052)*l9_51;
float l9_53=(isHovered*smoothstep(Port_Input0_N166*l9_1,Port_Input1_N165,l9_13))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_30),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_30),0.0,1.0))*((((0.0+((l9_33*l9_36)*scaleHandles.x))+((l9_38*l9_36)*scaleHandles.y))+((l9_38*l9_40)*scaleHandles.z))+((l9_33*l9_40)*scaleHandles.w)));
vec4 l9_54=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_54.w=l9_53;
vec4 l9_55=mix(vec4((Port_Value_N151.xyz*l9_52)+((l9_49*vec4(Port_Input1_N149)).xyz*l9_50),max(l9_52,l9_50)),l9_54,vec4(l9_53));
vec3 l9_56=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_18),vec3(l9_22))+l9_55.xyz;
float l9_57=l9_55.w*opacity;
vec4 l9_58=vec4(l9_56.x,l9_56.y,l9_56.z,vec4(0.0).w);
l9_58.w=l9_57;
if ((step(l9_57,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
...
{
l9_80=sc_SampleView(sc_ScreenTextureDims.xy,l9_78,sc_ScreenTextureLayout,l9_79,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_80=sc_SampleView(sc_ScreenTextureDims.xy,l9_78,sc_ScreenTextureLayout,l9_79,0.0,sc_ScreenTexture);
}
#endif
l9_74=l9_80;
}
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_94-0.0039215689)),min(1.0,l9_94+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_96),packValue(l9_96),packValue(l9_96),packValue(l9_96)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_108=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
