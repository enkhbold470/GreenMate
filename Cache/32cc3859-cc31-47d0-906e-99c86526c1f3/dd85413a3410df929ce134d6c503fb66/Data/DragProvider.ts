...
export class DragProvider {
   ...
   */
    getDragVector(currentPosition: vec3 | null,
        enableInstantDrag: boolean | null): vec3 | null {
    ...
    private isDragDetected(position: vec3,
        enableInstantDrag: boolean | null): boolean {
