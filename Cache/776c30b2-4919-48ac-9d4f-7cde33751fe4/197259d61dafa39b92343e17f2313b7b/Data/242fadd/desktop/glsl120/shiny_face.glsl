...
{
Color=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),UVCoord,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
vec3 l9_0=(Color.xyz*1.9921875)-vec3(1.0);
Color=vec4(l9_0.x,l9_0.y,l9_0.z,Color.w);
}
...
Value1=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),param_6,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTex).xyz;
Result=Value1;
}
#else
{
...
Value1=Globals.VertexColor.xyz*vec3(sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),param_6,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex).z);
Result=Value1;
}
#else
{
vec2 param_26;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),param_26,Globals);
Default=vec3(sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),param_26,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex).z);
Result=Default;
}
#endif
}
...
#endif
l9_13=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_20,l9_14,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x;
}
#else
{
...
#endif
float l9_22=(baseColor*l9_12).w*l9_13;
...
{
vec3 l9_27;
Node132_If_else(0.0,vec3(0.0),Port_Default_N132,l9_27,l9_8);
l9_26=varColor.xyz+l9_27;
}
#else
{
vec3 l9_28;
Node132_If_else(0.0,vec3(0.0),Port_Default_N132,l9_28,l9_8);
l9_26=l9_28;
}
#endif
l9_25=ssSRGB_to_Linear((l9_26*emissiveColor)*vec3(emissiveIntensity));
}
#else
{
l9_25=Port_Default_N103;
}
#endif
vec3 l9_29;
#if (Tweak_N179)
{
vec3 l9_30;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_30,l9_8);
vec3 l9_31=l9_30;
vec3 l9_32=reflect(l9_7,l9_31)*Port_Input1_N257;
float l9_33=l9_32.x;
float l9_34=l9_32.y;
float l9_35=l9_32.z+Port_Input1_N264;
float l9_36=((l9_33*l9_33)+(l9_34*l9_34))+(l9_35*l9_35);
float l9_37;
if (l9_36<=0.0)
{
l9_37=0.0;
...
float l9_38=l9_37*Port_Input1_N268;
int l9_39;
...
#endif
vec4 l9_40=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,l9_39,vec2(1.0)-((vec2(l9_33,l9_34)/vec2(l9_38))+vec2(Port_Input1_N270)),(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTex);
vec3 l9_41;
#if (Tweak_N177)
{
vec2 l9_42;
...
{
vec2 l9_45;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_45,l9_8);
l9_44=l9_45;
}
#else
{
...
{
vec2 l9_47;
Node35_If_else(0.0,vec2(0.0),vec2(0.0),l9_47,l9_8);
l9_46=l9_47;
}
#else
{
...
{
vec2 l9_54;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_54,l9_8);
l9_53=l9_54;
}
#else
{
...
{
vec2 l9_56;
Node35_If_else(0.0,vec2(0.0),vec2(0.0),l9_56,l9_8);
l9_55=l9_56;
}
#else
{
l9_55=varPackedTex.xy;
}
#endif
l9_53=l9_55;
}
...
#endif
l9_50=sc_SampleTextureBiasOrLevel(rimColorTexDims.xy,rimColorTexLayout,l9_57,l9_51,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex),(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0),rimColorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0),rimColorTexBorderColor,0.0,rimColorTex).xyz;
}
#else
{
l9_50=Port_Default_N170;
}
#endif
vec3 l9_58=ssSRGB_to_Linear((rimColor*vec3(rimIntensity))*l9_50);
float l9_59;
#if (rimInvert)
{
vec3 l9_60;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_60,l9_8);
l9_59=abs(dot(l9_60,-l9_7));
}
#else
{
vec3 l9_61;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_61,l9_8);
l9_59=1.0-abs(dot(l9_61,-l9_7));
}
#endif
float l9_62;
if (l9_59<=0.0)
...
{
l9_62=pow(l9_59,rimExponent);
}
l9_49=l9_58*vec3(l9_62);
}
#else
{
l9_49=Port_Default_N173;
}
#endif
vec3 l9_63=l9_25+l9_29;
vec3 l9_64=l9_63+l9_49;
vec3 l9_65;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_65=vec3(pow(l9_64.x,0.45454544),pow(l9_64.y,0.45454544),pow(l9_64.z,0.45454544));
}
#else
{
l9_65=sqrt(l9_64);
...
vec4 l9_66=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),param_16,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
vec3 param_33;
Node188_If_else(0.0,vec3(0.0),vec3(0.0),param_33,l9_8);
vec3 l9_67=param_33;
vec3 l9_68;
#if (Tweak_N179)
{
l9_68=Port_Value1_N079;
}
#else
{
vec3 l9_69;
...
{
vec2 l9_70;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_70,l9_8);
vec3 l9_71=vec3(metallic*sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_70,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex).x);
vec3 l9_72=mix(Port_Input0_N239,Port_Import_N235*l9_71,l9_71);
vec3 l9_73;
Node188_If_else(0.0,vec3(0.0),vec3(0.0),l9_73,l9_8);
l9_69=mix(Port_Input0_N325,mix((vec3(1.0-specularAoDarkening)*l9_72)*l9_72,Port_Input1_N322,l9_73),vec3(specularAoIntensity));
}
#else
{
l9_69=Port_Default_N326;
}
#endif
l9_68=l9_69;
}
...
#endif
float l9_75=clamp(l9_23,0.0,1.0);
...
#endif
vec3 l9_76=max(l9_9.xyz,vec3(0.0));
vec4 l9_77;
#if (sc_ProjectiveShadowsCaster)
{
l9_77=vec4(l9_76,l9_75);
}
#else
{
float l9_78=clamp(metallic*l9_66.x,0.0,1.0);
float l9_79=clamp(roughness*l9_66.y,0.0,1.0);
vec3 l9_80=clamp(l9_68,vec3(0.0),vec3(1.0));
vec3 l9_81=ssSRGB_to_Linear(l9_76);
vec3 l9_82=normalize(l9_74);
vec3 l9_83=ssSRGB_to_Linear(max(l9_65,vec3(0.0)));
vec3 l9_84;
#if (sc_SSAOEnabled)
{
l9_84=evaluateSSAO(varPos);
}
#else
{
l9_84=clamp(l9_67,vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_85=vec3(l9_78);
vec3 l9_86=mix(vec3(0.039999999),l9_81*l9_78,l9_85);
vec3 l9_87=mix(l9_81*(1.0-l9_78),vec3(0.0),l9_85);
SurfaceProperties l9_88=SurfaceProperties(l9_87,l9_75,l9_82,varPos,l9_7,l9_78,l9_79,l9_83,l9_84,l9_80,vec3(1.0),l9_86);
vec4 l9_89=vec4(1.0);
vec3 l9_90;
vec3 l9_91;
vec3 l9_92;
...
l9_98=vec3(0.0);
l9_97=vec3(0.0);
LightingComponents l9_104;
LightProperties l9_105;
SurfaceProperties l9_106;
vec3 l9_107;
int l9_108=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_108<sc_DirectionalLightsCount)
{
LightingComponents l9_109=accumulateLight(LightingComponents(l9_97,l9_98,l9_103,l9_102,l9_100,l9_99),LightProperties(sc_DirectionalLights[l9_108].direction,sc_DirectionalLights[l9_108].color.xyz,sc_DirectionalLights[l9_108].color.w*l9_89[(l9_101<3) ? l9_101 : 3]),l9_88,l9_7);
l9_103=l9_109.indirectDiffuse;
l9_102=l9_109.indirectSpecular;
l9_101++;
l9_100=l9_109.emitted;
l9_99=l9_109.transmitted;
l9_98=l9_109.directSpecular;
l9_97=l9_109.directDiffuse;
l9_108++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_126<sc_PointLightsCount)
{
vec3 l9_128=sc_PointLights[l9_126].position-varPos;
vec3 l9_129=normalize(l9_128);
float l9_130=l9_89[(l9_127<3) ? l9_127 : 3];
float l9_131=clamp((dot(l9_129,sc_PointLights[l9_126].direction)*sc_PointLights[l9_126].angleScale)+sc_PointLights[l9_126].angleOffset,0.0,1.0);
float l9_132=(sc_PointLights[l9_126].color.w*l9_130)*(l9_131*l9_131);
float l9_133;
if (sc_PointLights[l9_126].falloffEnabled)
{
l9_133=l9_132*computeDistanceAttenuation(length(l9_128),sc_PointLights[l9_126].falloffEndDistance);
}
else
{
l9_133=l9_132;
...
l9_119=l9_127+1;
LightingComponents l9_134=accumulateLight(LightingComponents(l9_113,l9_114,l9_118,l9_117,l9_116,l9_115),LightProperties(l9_129,sc_PointLights[l9_126].color.xyz,l9_133),l9_88,l9_7);
l9_120=l9_134.directDiffuse;
l9_121=l9_134.directSpecular;
l9_122=l9_134.indirectDiffuse;
l9_123=l9_134.indirectSpecular;
l9_124=l9_134.emitted;
l9_125=l9_134.transmitted;
l9_118=l9_122;
l9_117=l9_123;
l9_127=l9_119;
l9_116=l9_124;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_138=abs(varShadowTex-vec2(0.5));
vec4 l9_139=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_138.x,l9_138.y),0.5);
l9_137=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_139.xyz,vec3(sc_ShadowColor.w)),vec3(l9_139.w*sc_ShadowDensity));
}
#else
{
l9_137=vec3(1.0);
...
#endif
l9_136=l9_110*l9_137;
l9_135=l9_111*l9_137;
}
#else
{
l9_136=l9_110;
...
{
vec2 l9_141=calcPanoramicTexCoordsFromDir(l9_82,sc_EnvmapRotation.y);
vec4 l9_142;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_143=calcSeamlessPanoramicUvsForSampling(l9_141,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_143=l9_141;
...
#endif
l9_142=sc_EnvmapSpecularSampleViewIndexBias(l9_143,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_144;
...
{
vec2 l9_145=calcSeamlessPanoramicUvsForSampling(l9_141,sc_EnvmapDiffuseSize.xy,0.0);
int l9_146;
...
#endif
l9_144=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_145,sc_EnvmapDiffuseLayout,l9_146,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_144=sc_EnvmapSpecularSampleViewIndexBias(l9_141,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_142=l9_144;
}
#endif
l9_140=(l9_142.xyz*(1.0/l9_142.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_147;
...
float l9_151=l9_148.z;
l9_147=(((((((sc_Sh[8]*0.42904299)*((l9_149*l9_149)-(l9_150*l9_150)))+((sc_Sh[6]*0.74312502)*(l9_151*l9_151)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_149*l9_150))+(sc_Sh[7]*(l9_149*l9_151)))+(sc_Sh[5]*(l9_150*l9_151)))*0.85808599))+((((sc_Sh[3]*l9_149)+(sc_Sh[1]*l9_150))+(sc_Sh[2]*l9_151))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_147=vec3(0.0);
...
{
l9_153=l9_140+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_154=l9_140;
l9_154.x=l9_140.x+(1e-06*sc_AmbientLights[0].color.x);
l9_153=l9_154;
}
#endif
l9_152=l9_153;
...
{
l9_156=l9_152+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_157=l9_152;
l9_157.x=l9_152.x+(1e-06*sc_AmbientLights[1].color.x);
l9_156=l9_157;
}
#endif
l9_155=l9_156;
...
{
l9_159=l9_155+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_160=l9_155;
l9_160.x=l9_155.x+(1e-06*sc_AmbientLights[2].color.x);
l9_159=l9_160;
}
#endif
l9_158=l9_159;
...
{
vec3 l9_162;
l9_162=sc_LightEstimationData.ambientLight;
vec3 l9_163;
int l9_164=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_164<sc_LightEstimationSGCount)
{
float l9_165=dot(sc_LightEstimationData.sg[l9_164].axis,l9_82);
float l9_166=exp(-sc_LightEstimationData.sg[l9_164].sharpness);
float l9_167=l9_166*l9_166;
float l9_168=1.0/sc_LightEstimationData.sg[l9_164].sharpness;
float l9_169=(1.0+(2.0*l9_167))-l9_168;
float l9_170=sqrt(1.0-l9_169);
float l9_171=0.36000001*l9_165;
float l9_172=(1.0/(4.0*0.36000001))*l9_170;
float l9_173=l9_171+l9_172;
float l9_174;
if (step(abs(l9_171),l9_172)>0.5)
{
l9_174=(l9_173*l9_173)/l9_170;
}
else
{
l9_174=clamp(l9_165,0.0,1.0);
}
l9_163=l9_162+((((sc_LightEstimationData.sg[l9_164].color/vec3(sc_LightEstimationData.sg[l9_164].sharpness))*6.2831855)*((l9_169*l9_174)+(((l9_166-l9_167)*l9_168)-l9_167)))/vec3(3.1415927));
l9_162=l9_163;
l9_164++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_176=clamp(pow(l9_79,0.66666669),0.0,1.0)*5.0;
vec2 l9_177=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_82,reflect(-l9_7,l9_82),l9_79),sc_EnvmapRotation.y);
vec4 l9_178;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_179=floor(l9_176);
float l9_180=ceil(l9_176);
l9_178=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_177,sc_EnvmapSpecularSize.xy,l9_179),sc_EnvmapSpecularGetStereoViewIndex(),l9_179),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_177,sc_EnvmapSpecularSize.xy,l9_180),sc_EnvmapSpecularGetStereoViewIndex(),l9_180),vec4(l9_176-l9_179));
}
#else
{
l9_178=sc_EnvmapSpecularSampleViewIndexLevel(l9_177,sc_EnvmapSpecularGetStereoViewIndex(),l9_176);
}
#endif
l9_175=vec3(0.0)+((((l9_178.xyz*(1.0/l9_178.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_88,abs(dot(l9_82,l9_7))));
}
#else
{
l9_175=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_182=clamp(l9_79*l9_79,0.0099999998,1.0);
vec3 l9_183;
l9_183=sc_LightEstimationData.ambientLight*l9_86;
int l9_184=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_184<sc_LightEstimationSGCount)
{
float l9_185=l9_182*l9_182;
vec3 l9_186=reflect(-l9_7,l9_82);
float l9_187=dot(l9_82,l9_7);
float l9_188=(2.0/l9_185)/(4.0*max(l9_187,9.9999997e-05));
float l9_189=length((l9_186*l9_188)+(sc_LightEstimationData.sg[l9_184].axis*sc_LightEstimationData.sg[l9_184].sharpness));
float l9_190=clamp(dot(l9_82,l9_186),0.0,1.0);
float l9_191=clamp(l9_187,0.0,1.0);
float l9_192=1.0-l9_185;
l9_183+=((((((((vec3(1.0/(3.1415927*l9_185))*exp((l9_189-l9_188)-sc_LightEstimationData.sg[l9_184].sharpness))*sc_LightEstimationData.sg[l9_184].color)*6.2831855)*(1.0-exp((-2.0)*l9_189)))/vec3(l9_189))*((1.0/(l9_190+sqrt(l9_185+((l9_192*l9_190)*l9_190))))*(1.0/(l9_191+sqrt(l9_185+((l9_192*l9_191)*l9_191))))))*(l9_86+((vec3(1.0)-l9_86)*pow(1.0-clamp(dot(l9_186,normalize(l9_186+l9_7)),0.0,1.0),5.0))))*l9_190);
l9_184++;
continue;
}
else
...
l9_196=vec3(0.0);
l9_195=vec3(0.0);
l9_194=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_87,vec3(l9_75));
l9_193=1.0;
}
#else
{
...
#endif
vec3 l9_198=l9_195*l9_84;
vec3 l9_199=l9_196+l9_198;
vec3 l9_200=l9_87*l9_199;
vec3 l9_201=l9_181*l9_80;
vec3 l9_202=l9_135+l9_201;
vec3 l9_203;
if (l9_197)
{
l9_203=l9_200*srgbToLinear(l9_193);
}
else
{
l9_203=l9_200;
}
vec3 l9_204=l9_203+l9_202;
vec3 l9_205=(l9_204+l9_83)+l9_194;
float l9_206=l9_205.x;
vec4 l9_207=vec4(l9_206,l9_205.yz,l9_193);
vec4 l9_208;
#if (sc_IsEditor)
{
vec4 l9_209=l9_207;
l9_209.x=l9_206+((l9_84.x*l9_80.x)*9.9999997e-06);
l9_208=l9_209;
}
#else
{
...
{
vec3 l9_211=l9_208.xyz*1.8;
vec3 l9_212=(l9_208.xyz*(l9_211+vec3(1.4)))/((l9_208.xyz*(l9_211+vec3(0.5)))+vec3(1.5));
l9_210=vec4(l9_212.x,l9_212.y,l9_212.z,l9_208.w);
}
#else
{
l9_210=l9_208;
...
#endif
vec3 l9_213=vec3(linearToSrgb(l9_210.x),linearToSrgb(l9_210.y),linearToSrgb(l9_210.z));
l9_77=vec4(l9_213.x,l9_213.y,l9_213.z,l9_210.w);
}
#endif
vec4 l9_214=max(l9_77,vec4(0.0));
vec4 l9_215;
#if (sc_ProjectiveShadowsCaster)
{
float l9_216;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_217=clamp(l9_214.w*2.0,0.0,1.0);
}
#else
{
float l9_218;
...
{
l9_218=clamp(dot(l9_214.xyz,vec3(l9_214.w)),0.0,1.0);
}
#else
{
float l9_219;
...
#if (sc_BlendMode_Multiply)
{
l9_220=(1.0-dot(l9_214.xyz,vec3(0.33333001)))*l9_214.w;
}
#else
{
float l9_221;
...
{
l9_221=(1.0-clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0))*l9_214.w;
}
#else
{
float l9_222;
#if (sc_BlendMode_ColoredGlass)
{
l9_222=clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0)*l9_214.w;
}
#else
{
float l9_223;
#if (sc_BlendMode_Add)
{
l9_223=clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_224;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_224=clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0)*l9_214.w;
}
#else
{
float l9_225;
...
{
l9_225=dot(l9_214.xyz,vec3(0.33333001))*l9_214.w;
}
#else
{
float l9_226;
#if (sc_BlendMode_Min)
{
l9_226=1.0-clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_227;
#if (sc_BlendMode_Max)
{
l9_227=clamp(dot(l9_214.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_227=1.0;
...
#endif
l9_215=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_214.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_216);
}
#else
{
vec4 l9_228;
...
{
vec3 l9_230=sc_GetFramebufferColor().xyz;
vec3 l9_231=mix(l9_230,definedBlend(l9_230,l9_214.xyz).xyz,vec3(l9_214.w));
vec4 l9_232=vec4(l9_231.x,l9_231.y,l9_231.z,vec4(0.0).w);
l9_232.w=1.0;
l9_229=l9_232;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_234=l9_214.w;
l9_233=vec4(mix(vec3(1.0),l9_214.xyz,vec3(l9_234)),l9_234);
}
#else
{
vec4 l9_235;
...
{
float l9_236=l9_214.w;
float l9_237;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_237=clamp(l9_236,0.0,1.0);
}
#else
{
l9_237=l9_236;
...
#endif
l9_235=vec4(l9_214.xyz*l9_237,l9_237);
}
#else
{
l9_235=l9_214;
...
{
l9_240=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_240=vec4(0.0);
...
vec4 l9_242=outputMotionVectorsIfNeeded(varPos,max(l9_241,vec4(0.0)));
vec4 l9_243=clamp(l9_242,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_244=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_244-0.0039215689)),min(1.0,l9_244+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_245=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_246=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_245).xy);
float l9_247=packValue(l9_246);
int l9_254=int(l9_243.w*255.0);
float l9_255=packValue(l9_254);
sc_writeFragData0(vec4(packValue(l9_246),packValue(l9_246),packValue(l9_246),packValue(l9_246)));
sc_writeFragData1(vec4(l9_247,packValue(l9_246),packValue(l9_246),packValue(l9_246)));
sc_writeFragData2(vec4(l9_255,packValue(l9_254),packValue(l9_254),packValue(l9_254)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_258=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_258).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_263==0)
{
l9_266=texture2D(sc_OITAlpha0,l9_258);
l9_265=texture2D(sc_OITDepthLow0,l9_258);
l9_264=texture2D(sc_OITDepthHigh0,l9_258);
}
else
{
l9_266=vec4(0.0);
...
if (l9_263==1)
{
l9_269=texture2D(sc_OITAlpha1,l9_258);
l9_268=texture2D(sc_OITDepthLow1,l9_258);
l9_267=texture2D(sc_OITDepthHigh1,l9_258);
}
else
{
l9_269=l9_266;
...
if (any(notEqual(l9_267,vec4(0.0)))||any(notEqual(l9_268,vec4(0.0))))
{
int l9_270[8]=l9_259;
unpackValues(l9_267.w,l9_263,l9_270);
unpackValues(l9_267.z,l9_263,l9_270);
unpackValues(l9_267.y,l9_263,l9_270);
unpackValues(l9_267.x,l9_263,l9_270);
unpackValues(l9_268.w,l9_263,l9_270);
unpackValues(l9_268.z,l9_263,l9_270);
unpackValues(l9_268.y,l9_263,l9_270);
unpackValues(l9_268.x,l9_263,l9_270);
int l9_279[8]=l9_260;
unpackValues(l9_269.w,l9_263,l9_279);
unpackValues(l9_269.z,l9_263,l9_279);
unpackValues(l9_269.y,l9_263,l9_279);
unpackValues(l9_269.x,l9_263,l9_279);
}
l9_263++;
continue;
}
...
vec4 l9_284=texture2D(sc_OITFilteredDepthBoundsTexture,l9_258);
vec2 l9_285=l9_284.xy;
int l9_286;
#if (sc_SkinBonesCount>0)
{
l9_286=encodeDepth(((1.0-l9_284.x)*1000.0)+getDepthOrderingEpsilon(),l9_285);
}
#else
{
l9_286=0;
...
#endif
int l9_287=encodeDepth(viewSpaceDepth(),l9_285);
vec4 l9_288;
l9_288=l9_243*l9_243.w;
vec4 l9_289;
int l9_290=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_290<8)
{
int l9_291=l9_259[l9_290];
int l9_292=l9_287-l9_286;
bool l9_293=l9_291<l9_292;
bool l9_294;
if (l9_293)
{
l9_294=l9_259[l9_290]>0;
}
else
{
l9_294=l9_293;
...
if (l9_294)
{
vec3 l9_295=l9_288.xyz*(1.0-(float(l9_260[l9_290])/255.0));
l9_289=vec4(l9_295.x,l9_295.y,l9_295.z,l9_288.w);
}
else
{
l9_289=l9_288;
