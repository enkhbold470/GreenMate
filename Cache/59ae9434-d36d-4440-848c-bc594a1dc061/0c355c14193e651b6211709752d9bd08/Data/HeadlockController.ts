...
export default class DefaultHeadlockController {
                ...
                case RotationAxis.Yaw:
                    rotationOffset = this.yawCalculator.getOffset(
                        ...
                        this.headlockComponent.lockedPitch
                            ? this.cameraTransform.up.projectOnPlane(new vec3(this.cameraTransform.left.x,
                                0,
    ...
    public resetPosition(): void {
        ...
        const pitchQuaternion = quat.angleAxis(MathUtils.DegToRad * (this.headlockComponent.pitchOffsetDegrees ?? 0),
            vec3.left());
        offset = pitchQuaternion.multiplyVec3(offset);
        const yawQuaternion = quat.angleAxis(MathUtils.DegToRad * (this.headlockComponent.yawOffsetDegrees ?? 0),
            vec3.up());
