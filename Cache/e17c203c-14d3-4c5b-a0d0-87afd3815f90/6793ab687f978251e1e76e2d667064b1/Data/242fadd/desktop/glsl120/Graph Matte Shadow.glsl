...
//sampler sampler opacityTexSmpSC 2:17
...
//texture texture2D opacityTex 2:1:2:17
...
uniform vec2 Tweak_N14;
uniform vec2 Tweak_N15;
uniform vec2 Tweak_N50;
uniform vec2 Tweak_N51;
uniform vec3 Port_Input0_N006;
uniform float Port_Import_N201;
uniform float Port_Import_N010;
uniform float Port_Import_N009;
uniform vec2 Port_Import_N011;
uniform vec2 Port_Import_N012;
...
void Node0_Shadow_Sample(out vec3 Color,ssGlobals Globals)
{
#if (sc_ProjectiveShadowsReceiver)
{
Color=evaluateShadow();
}
#else
{
Color=vec3(1.0);
...
Value1=((param_5*Tweak_N14)+Tweak_N15)+(Tweak_N15*(Globals.gTimeElapsed*Port_Speed_N022));
Result=Value1;
}
#else
{
...
Default=(param_12*Tweak_N14)+Tweak_N15;
Result=Default;
}
#endif
}
...
{
vec2 l9_12;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_12,l9_5);
float l9_13;
Node67_Bool_Parameter(l9_13,l9_5);
l9_11=mix(varPackedTex.xy,l9_12,vec2(l9_13));
}
#else
{
vec2 l9_14;
...
{
vec2 l9_16;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_16,l9_5);
l9_15=((l9_16*Tweak_N50)+Tweak_N51)+(Tweak_N51*(l9_1*Port_Speed_N063));
}
#else
{
vec2 l9_17;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_17,l9_5);
l9_15=(l9_17*Tweak_N50)+Tweak_N51;
}
#endif
float l9_18;
#if (Tweak_N25)
...
#endif
l9_14=mix(varPackedTex.xy,l9_15,vec2(l9_18-0.001));
}
#else
{
...
#endif
l9_6=mix(Port_Input0_N006,l9_8,vec3(sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_19,l9_9,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x));
}
#else
{
vec3 l9_20;
Node0_Shadow_Sample(l9_20,l9_5);
l9_6=l9_20;
}
#endif
vec4 l9_21=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_21.w=Port_Value2_N001;
...
{
l9_24=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_21.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_21.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_30;
#if (sc_BlendMode_Add)
{
l9_30=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_21.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_33;
#if (sc_BlendMode_Min)
{
l9_33=1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_Max)
{
l9_34=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_34=1.0;
...
#endif
l9_22=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_21.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_23);
}
#else
{
vec4 l9_35;
...
#else
{
vec2 l9_41=sc_ScreenCoordsGlobalToView(l9_3);
int l9_42;
...
#endif
l9_37=sc_SampleView(sc_ScreenTextureDims.xy,l9_41,sc_ScreenTextureLayout,l9_42,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_43;
...
{
vec4 l9_44=l9_37;
l9_44.x=l9_37.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_43=l9_44;
}
#else
{
...
#endif
vec3 l9_45=mix(l9_43.xyz,definedBlend(l9_43.xyz,l9_21.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_47=vec4(mix(vec3(1.0),l9_21.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_48;
...
{
l9_49=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_49=Port_Value2_N001;
}
#endif
l9_48=vec4(l9_21.xyz*l9_49,l9_49);
}
#else
{
l9_48=l9_21;
...
{
l9_52=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_52=vec4(0.0);
...
vec4 l9_54=outputMotionVectorsIfNeeded(varPos,max(l9_53,vec4(0.0)));
vec4 l9_55=clamp(l9_54,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_56=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_56-0.0039215689)),min(1.0,l9_56+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_57=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_58=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_57).xy);
float l9_59=packValue(l9_58);
int l9_66=int(l9_55.w*255.0);
float l9_67=packValue(l9_66);
sc_writeFragData0(vec4(packValue(l9_58),packValue(l9_58),packValue(l9_58),packValue(l9_58)));
sc_writeFragData1(vec4(l9_59,packValue(l9_58),packValue(l9_58),packValue(l9_58)));
sc_writeFragData2(vec4(l9_67,packValue(l9_66),packValue(l9_66),packValue(l9_66)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_70=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_75==0)
{
l9_78=texture2D(sc_OITAlpha0,l9_70);
l9_77=texture2D(sc_OITDepthLow0,l9_70);
l9_76=texture2D(sc_OITDepthHigh0,l9_70);
}
else
{
l9_78=vec4(0.0);
...
if (l9_75==1)
{
l9_81=texture2D(sc_OITAlpha1,l9_70);
l9_80=texture2D(sc_OITDepthLow1,l9_70);
l9_79=texture2D(sc_OITDepthHigh1,l9_70);
}
else
{
l9_81=l9_78;
...
if (any(notEqual(l9_79,vec4(0.0)))||any(notEqual(l9_80,vec4(0.0))))
{
int l9_82[8]=l9_71;
unpackValues(l9_79.w,l9_75,l9_82);
unpackValues(l9_79.z,l9_75,l9_82);
unpackValues(l9_79.y,l9_75,l9_82);
unpackValues(l9_79.x,l9_75,l9_82);
unpackValues(l9_80.w,l9_75,l9_82);
unpackValues(l9_80.z,l9_75,l9_82);
unpackValues(l9_80.y,l9_75,l9_82);
unpackValues(l9_80.x,l9_75,l9_82);
int l9_91[8]=l9_72;
unpackValues(l9_81.w,l9_75,l9_91);
unpackValues(l9_81.z,l9_75,l9_91);
unpackValues(l9_81.y,l9_75,l9_91);
unpackValues(l9_81.x,l9_75,l9_91);
}
l9_75++;
continue;
}
...
vec4 l9_96=texture2D(sc_OITFilteredDepthBoundsTexture,l9_70);
vec2 l9_97=l9_96.xy;
int l9_98;
#if (sc_SkinBonesCount>0)
{
l9_98=encodeDepth(((1.0-l9_96.x)*1000.0)+getDepthOrderingEpsilon(),l9_97);
}
#else
{
l9_98=0;
...
#endif
int l9_99=encodeDepth(viewSpaceDepth(),l9_97);
vec4 l9_100;
l9_100=l9_55*l9_55.w;
vec4 l9_101;
int l9_102=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_102<8)
{
int l9_103=l9_71[l9_102];
int l9_104=l9_99-l9_98;
bool l9_105=l9_103<l9_104;
bool l9_106;
if (l9_105)
{
l9_106=l9_71[l9_102]>0;
}
else
{
l9_106=l9_105;
...
if (l9_106)
{
vec3 l9_107=l9_100.xyz*(1.0-(float(l9_72[l9_102])/255.0));
l9_101=vec4(l9_107.x,l9_107.y,l9_107.z,l9_100.w);
}
else
{
l9_101=l9_100;
