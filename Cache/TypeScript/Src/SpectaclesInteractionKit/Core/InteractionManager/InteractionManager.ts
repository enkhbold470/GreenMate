...
export class InteractionManager {
  ...
  */
   ...
   * @returns an array of {@link ColliderComponent}
   */
    private findCollidersForSceneObject(sceneObject: SceneObject,
        colliders: ColliderComponent[],
        isRoot: boolean = false): ColliderComponent[] {
      ...
      foundColliders.find((collider: ColliderComponent) =>
          this.colliderToInteractableMap.has(collider)) !== undefined;
