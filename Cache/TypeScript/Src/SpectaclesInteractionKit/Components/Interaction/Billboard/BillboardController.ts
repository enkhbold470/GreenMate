...
export default class BillboardController {
    ...
    public get axisEasing(): vec3 {
        return new vec3(this.xAxisCalculator.axisEasing,
    ...
    public get axisBufferDegrees(): vec3 {
        return new vec3(MathUtils.RadToDeg * this.xAxisCalculator.axisBufferRadians,
    ...
    private onUpdate(): void {
        ...
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                case RotationAxis.X:
                    rotationQuaternion = this.xAxisCalculator.getRotation(this.getRightVector(),
                        this.getForwardVector(),
                        targetToCamera,
                        this.getUpVector());
                    break;
                case RotationAxis.Y:
                    rotationQuaternion = this.yAxisCalculator.getRotation(VEC3_UP,
                        this.getForwardVector(),
                        targetToCamera,
                        this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
                    rotationQuaternion = this.zAxisCalculator.getRotation(this.getForwardVector(),
                        this.getUpVector(),
    ...
    public resetRotation() {
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                case RotationAxis.X:
                    rotationQuaternion = this.xAxisCalculator.resetRotation(this.getRightVector(),
                        this.getForwardVector(),
                        targetToCamera,
                        this.getUpVector());
                    break;
                case RotationAxis.Y:
                    rotationQuaternion = this.yAxisCalculator.resetRotation(VEC3_UP,
                        this.getForwardVector(),
                        targetToCamera,
                        this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
                    rotationQuaternion = this.zAxisCalculator.resetRotation(this.getForwardVector(),
                        this.getUpVector(),
                        this.getCameraUpVector(),
                        this.getRightVector());
                    break;
