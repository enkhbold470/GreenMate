...
export class CursorViewModel {
   ...
   */
    ...
    constructor(private enableCursorSnapping: boolean,
    ...
    setInteractor(interactor: Interactor) {
      ...
      this.interactor.onCurrentInteractableChanged.add((interactable) => {
          ...
          interactable !== null
              ? interactable.sceneObject.getComponent(InteractableManipulation.getTypeName())
              : null;
          this.isScrolling =
          interactable !== null
    ...
    private setupStateMachine() {
        ...
        this.stateMachine.addState({
            ...
            onEnter: () => {
                ...
                this.animateCursorDistance(distance,
                    'ease-in-out-cubic',
            ...
            onUpdate: () => {
                ...
                this.updateIndirectCursorPosition(this.interactor.interactionStrength ?? null,
                    position);
            },
            transitions: [
                {
         ...
         */
                this.updateIndirectCursorPosition(DEFAULT_MANIPULATE_STRENGTH,
                    this.getSnappedCursorPosition());
            },
            transitions: [
                {
   ...
   */
    ...
    private animateCursorDistance(distance: number,
   ...
   */
    private updateIndirectCursorPosition(interactionStrength: number | null,
        position: vec3 | null): void {
        if (position !== null) {
            if (!this.isAnimating) {
                this.cursorDistance =
    ...
    private calculateCursorScale(): number {
      ...
      this.cursorDistance <= DEFAULT_FAR_FIELD_THRESHOLD_CM
            ...
            const t = MathUtils.remap(this.cursorDistance,
