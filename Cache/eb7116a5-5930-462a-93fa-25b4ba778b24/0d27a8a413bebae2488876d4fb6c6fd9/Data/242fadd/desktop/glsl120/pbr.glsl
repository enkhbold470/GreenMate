...
//sampler sampler materialParamsTexSmpSC 2:20
//sampler sampler normalTexSmpSC 2:21
//sampler sampler sc_EnvmapDiffuseSmpSC 2:22
//sampler sampler sc_EnvmapSpecularSmpSC 2:23
//sampler sampler sc_OITCommonSampler 2:24
//sampler sampler sc_SSAOTextureSmpSC 2:25
//sampler sampler sc_ScreenTextureSmpSC 2:26
//sampler sampler sc_ShadowTextureSmpSC 2:27
//texture texture2D baseTex 2:0:2:18
//texture texture2D intensityTexture 2:1:2:19
//texture texture2D materialParamsTex 2:2:2:20
//texture texture2D normalTex 2:3:2:21
//texture texture2D sc_EnvmapDiffuse 2:4:2:22
//texture texture2D sc_EnvmapSpecular 2:5:2:23
...
//texture texture2D sc_SSAOTexture 2:14:2:25
//texture texture2D sc_ScreenTexture 2:15:2:26
//texture texture2D sc_ShadowTexture 2:16:2:27
//SG_REFLECTION_END
...
#endif
vec4 l9_5=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_4,l9_3,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
int l9_6;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,l9_6,l9_3,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
int l9_8;
...
#endif
float l9_11=clamp(l9_5.w,0.0,1.0);
...
{
if (l9_11<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_12=max(l9_5.xyz,vec3(0.0));
vec4 l9_13;
#if (sc_ProjectiveShadowsCaster)
{
l9_13=vec4(l9_12,l9_11);
}
#else
{
float l9_14=clamp(l9_9.x,0.0,1.0);
float l9_15=clamp(l9_9.y,0.0,1.0);
vec3 l9_16=ssSRGB_to_Linear(l9_12);
vec3 l9_17=normalize(l9_10);
vec3 l9_18=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_19;
#if (sc_SSAOEnabled)
{
l9_19=evaluateSSAO(varPos);
}
#else
{
l9_19=clamp(vec3(l9_9.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_20=vec3(l9_14);
vec3 l9_21=mix(vec3(0.039999999),l9_16*l9_14,l9_20);
vec3 l9_22=mix(l9_16*(1.0-l9_14),vec3(0.0),l9_20);
SurfaceProperties l9_23=SurfaceProperties(l9_22,l9_11,l9_17,varPos,l9_0,l9_14,l9_15,l9_18,l9_19,Port_SpecularAO_N006,vec3(1.0),l9_21);
vec4 l9_24=vec4(1.0);
vec3 l9_25;
vec3 l9_26;
vec3 l9_27;
...
l9_33=vec3(0.0);
l9_32=vec3(0.0);
LightingComponents l9_39;
LightProperties l9_40;
SurfaceProperties l9_41;
vec3 l9_42;
int l9_43=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_43<sc_DirectionalLightsCount)
{
LightingComponents l9_44=accumulateLight(LightingComponents(l9_32,l9_33,l9_38,l9_37,l9_35,l9_34),LightProperties(sc_DirectionalLights[l9_43].direction,sc_DirectionalLights[l9_43].color.xyz,sc_DirectionalLights[l9_43].color.w*l9_24[(l9_36<3) ? l9_36 : 3]),l9_23,l9_0);
l9_38=l9_44.indirectDiffuse;
l9_37=l9_44.indirectSpecular;
l9_36++;
l9_35=l9_44.emitted;
l9_34=l9_44.transmitted;
l9_33=l9_44.directSpecular;
l9_32=l9_44.directDiffuse;
l9_43++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_61<sc_PointLightsCount)
{
vec3 l9_63=sc_PointLights[l9_61].position-varPos;
vec3 l9_64=normalize(l9_63);
float l9_65=l9_24[(l9_62<3) ? l9_62 : 3];
float l9_66=clamp((dot(l9_64,sc_PointLights[l9_61].direction)*sc_PointLights[l9_61].angleScale)+sc_PointLights[l9_61].angleOffset,0.0,1.0);
float l9_67=(sc_PointLights[l9_61].color.w*l9_65)*(l9_66*l9_66);
float l9_68;
if (sc_PointLights[l9_61].falloffEnabled)
{
l9_68=l9_67*computeDistanceAttenuation(length(l9_63),sc_PointLights[l9_61].falloffEndDistance);
}
else
{
l9_68=l9_67;
...
l9_54=l9_62+1;
LightingComponents l9_69=accumulateLight(LightingComponents(l9_48,l9_49,l9_53,l9_52,l9_51,l9_50),LightProperties(l9_64,sc_PointLights[l9_61].color.xyz,l9_68),l9_23,l9_0);
l9_55=l9_69.directDiffuse;
l9_56=l9_69.directSpecular;
l9_57=l9_69.indirectDiffuse;
l9_58=l9_69.indirectSpecular;
l9_59=l9_69.emitted;
l9_60=l9_69.transmitted;
l9_53=l9_57;
l9_52=l9_58;
l9_62=l9_54;
l9_51=l9_59;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_73=abs(varShadowTex-vec2(0.5));
vec4 l9_74=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_73.x,l9_73.y),0.5);
l9_72=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_74.xyz,vec3(sc_ShadowColor.w)),vec3(l9_74.w*sc_ShadowDensity));
}
#else
{
l9_72=vec3(1.0);
...
{
vec2 l9_76=calcPanoramicTexCoordsFromDir(l9_17,sc_EnvmapRotation.y);
vec4 l9_77;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_78=calcSeamlessPanoramicUvsForSampling(l9_76,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_78=l9_76;
...
#endif
l9_77=sc_EnvmapSpecularSampleViewIndexBias(l9_78,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_79;
...
{
vec2 l9_80=calcSeamlessPanoramicUvsForSampling(l9_76,sc_EnvmapDiffuseSize.xy,0.0);
int l9_81;
...
#endif
l9_79=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_80,sc_EnvmapDiffuseLayout,l9_81,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_79=sc_EnvmapSpecularSampleViewIndexBias(l9_76,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_77=l9_79;
}
#endif
l9_75=(l9_77.xyz*(1.0/l9_77.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_82;
...
{
l9_88=l9_75+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_89=l9_75;
l9_89.x=l9_75.x+(1e-06*sc_AmbientLights[0].color.x);
l9_88=l9_89;
}
#endif
l9_87=l9_88;
...
{
l9_91=l9_87+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_92=l9_87;
l9_92.x=l9_87.x+(1e-06*sc_AmbientLights[1].color.x);
l9_91=l9_92;
}
#endif
l9_90=l9_91;
...
{
l9_94=l9_90+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_95=l9_90;
l9_95.x=l9_90.x+(1e-06*sc_AmbientLights[2].color.x);
l9_94=l9_95;
}
#endif
l9_93=l9_94;
...
{
vec3 l9_97;
l9_97=sc_LightEstimationData.ambientLight;
vec3 l9_98;
int l9_99=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_99<sc_LightEstimationSGCount)
{
float l9_100=dot(sc_LightEstimationData.sg[l9_99].axis,l9_17);
float l9_101=exp(-sc_LightEstimationData.sg[l9_99].sharpness);
float l9_102=l9_101*l9_101;
float l9_103=1.0/sc_LightEstimationData.sg[l9_99].sharpness;
float l9_104=(1.0+(2.0*l9_102))-l9_103;
float l9_105=sqrt(1.0-l9_104);
float l9_106=0.36000001*l9_100;
float l9_107=(1.0/(4.0*0.36000001))*l9_105;
float l9_108=l9_106+l9_107;
float l9_109;
if (step(abs(l9_106),l9_107)>0.5)
{
l9_109=(l9_108*l9_108)/l9_105;
}
else
{
l9_109=clamp(l9_100,0.0,1.0);
}
l9_98=l9_97+((((sc_LightEstimationData.sg[l9_99].color/vec3(sc_LightEstimationData.sg[l9_99].sharpness))*6.2831855)*((l9_104*l9_109)+(((l9_101-l9_102)*l9_103)-l9_102)))/vec3(3.1415927));
l9_97=l9_98;
l9_99++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_111=clamp(pow(l9_15,0.66666669),0.0,1.0)*5.0;
vec2 l9_112=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_17,reflect(-l9_0,l9_17),l9_15),sc_EnvmapRotation.y);
vec4 l9_113;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_114=floor(l9_111);
float l9_115=ceil(l9_111);
l9_113=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_112,sc_EnvmapSpecularSize.xy,l9_114),sc_EnvmapSpecularGetStereoViewIndex(),l9_114),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_112,sc_EnvmapSpecularSize.xy,l9_115),sc_EnvmapSpecularGetStereoViewIndex(),l9_115),vec4(l9_111-l9_114));
}
#else
{
l9_113=sc_EnvmapSpecularSampleViewIndexLevel(l9_112,sc_EnvmapSpecularGetStereoViewIndex(),l9_111);
}
#endif
l9_110=vec3(0.0)+((((l9_113.xyz*(1.0/l9_113.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_23,abs(dot(l9_17,l9_0))));
}
#else
{
l9_110=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_117=clamp(l9_15*l9_15,0.0099999998,1.0);
vec3 l9_118;
l9_118=sc_LightEstimationData.ambientLight*l9_21;
int l9_119=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_119<sc_LightEstimationSGCount)
{
float l9_120=l9_117*l9_117;
vec3 l9_121=reflect(-l9_0,l9_17);
float l9_122=dot(l9_17,l9_0);
float l9_123=(2.0/l9_120)/(4.0*max(l9_122,9.9999997e-05));
float l9_124=length((l9_121*l9_123)+(sc_LightEstimationData.sg[l9_119].axis*sc_LightEstimationData.sg[l9_119].sharpness));
float l9_125=clamp(dot(l9_17,l9_121),0.0,1.0);
float l9_126=clamp(l9_122,0.0,1.0);
float l9_127=1.0-l9_120;
l9_118+=((((((((vec3(1.0/(3.1415927*l9_120))*exp((l9_124-l9_123)-sc_LightEstimationData.sg[l9_119].sharpness))*sc_LightEstimationData.sg[l9_119].color)*6.2831855)*(1.0-exp((-2.0)*l9_124)))/vec3(l9_124))*((1.0/(l9_125+sqrt(l9_120+((l9_127*l9_125)*l9_125))))*(1.0/(l9_126+sqrt(l9_120+((l9_127*l9_126)*l9_126))))))*(l9_21+((vec3(1.0)-l9_21)*pow(1.0-clamp(dot(l9_121,normalize(l9_121+l9_0)),0.0,1.0),5.0))))*l9_125);
l9_119++;
continue;
}
else
...
l9_131=vec3(0.0);
l9_130=vec3(0.0);
l9_129=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_22,vec3(l9_11));
l9_128=1.0;
}
#else
{
...
#endif
vec3 l9_133=l9_130*l9_19;
vec3 l9_134=l9_131+l9_133;
vec3 l9_135=l9_22*l9_134;
vec3 l9_136=l9_116*Port_SpecularAO_N006;
vec3 l9_137=l9_70+l9_136;
vec3 l9_138;
if (l9_132)
{
l9_138=l9_135*srgbToLinear(l9_128);
}
else
{
l9_138=l9_135;
...
vec3 l9_140=(l9_139+l9_18)+l9_129;
float l9_141=l9_140.x;
vec4 l9_142=vec4(l9_141,l9_140.yz,l9_128);
vec4 l9_143;
#if (sc_IsEditor)
{
vec4 l9_144=l9_142;
l9_144.x=l9_141+((l9_19.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_143=l9_144;
}
#else
{
...
#endif
vec3 l9_148=vec3(linearToSrgb(l9_145.x),linearToSrgb(l9_145.y),linearToSrgb(l9_145.z));
l9_13=vec4(l9_148.x,l9_148.y,l9_148.z,l9_145.w);
}
#endif
vec4 l9_149=max(l9_13,vec4(0.0));
vec4 l9_150;
#if (sc_ProjectiveShadowsCaster)
{
float l9_151;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_152=clamp(l9_149.w*2.0,0.0,1.0);
}
#else
{
float l9_153;
...
{
l9_153=clamp(dot(l9_149.xyz,vec3(l9_149.w)),0.0,1.0);
}
#else
{
float l9_154;
...
#if (sc_BlendMode_Multiply)
{
l9_155=(1.0-dot(l9_149.xyz,vec3(0.33333001)))*l9_149.w;
}
#else
{
float l9_156;
...
{
l9_156=(1.0-clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0))*l9_149.w;
}
#else
{
float l9_157;
#if (sc_BlendMode_ColoredGlass)
{
l9_157=clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0)*l9_149.w;
}
#else
{
float l9_158;
#if (sc_BlendMode_Add)
{
l9_158=clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_159;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_159=clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0)*l9_149.w;
}
#else
{
float l9_160;
...
{
l9_160=dot(l9_149.xyz,vec3(0.33333001))*l9_149.w;
}
#else
{
float l9_161;
#if (sc_BlendMode_Min)
{
l9_161=1.0-clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_162;
#if (sc_BlendMode_Max)
{
l9_162=clamp(dot(l9_149.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_162=1.0;
...
#endif
l9_150=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_149.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_151);
}
#else
{
vec4 l9_163;
...
{
vec3 l9_165=sc_GetFramebufferColor().xyz;
vec3 l9_166=mix(l9_165,definedBlend(l9_165,l9_149.xyz).xyz,vec3(l9_149.w));
vec4 l9_167=vec4(l9_166.x,l9_166.y,l9_166.z,vec4(0.0).w);
l9_167.w=1.0;
l9_164=l9_167;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_169=l9_149.w;
l9_168=vec4(mix(vec3(1.0),l9_149.xyz,vec3(l9_169)),l9_169);
}
#else
{
vec4 l9_170;
...
{
float l9_171=l9_149.w;
float l9_172;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_172=clamp(l9_171,0.0,1.0);
}
#else
{
l9_172=l9_171;
...
#endif
l9_170=vec4(l9_149.xyz*l9_172,l9_172);
}
#else
{
l9_170=l9_149;
...
vec4 l9_177=outputMotionVectorsIfNeeded(varPos,max(l9_176,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_179-0.0039215689)),min(1.0,l9_179+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_180=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_181=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_180).xy);
float l9_182=packValue(l9_181);
int l9_189=int(l9_178.w*255.0);
float l9_190=packValue(l9_189);
sc_writeFragData0(vec4(packValue(l9_181),packValue(l9_181),packValue(l9_181),packValue(l9_181)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_193=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_198==0)
{
l9_201=texture2D(sc_OITAlpha0,l9_193);
l9_200=texture2D(sc_OITDepthLow0,l9_193);
l9_199=texture2D(sc_OITDepthHigh0,l9_193);
}
else
{
l9_201=vec4(0.0);
...
if (l9_198==1)
{
l9_204=texture2D(sc_OITAlpha1,l9_193);
l9_203=texture2D(sc_OITDepthLow1,l9_193);
l9_202=texture2D(sc_OITDepthHigh1,l9_193);
}
else
{
l9_204=l9_201;
...
vec4 l9_219=texture2D(sc_OITFilteredDepthBoundsTexture,l9_193);
