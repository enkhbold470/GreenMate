...
export class PinchButton extends BaseScriptComponent {
  ...
  @input
  @hint('The names for the functions on the provided script, to be called on button pinch')
  @allowUndefined
  ...
  onAwake() {
      ...
      if (this.editEventCallbacks && this.customFunctionForOnButtonPinched) {
          this.onButtonPinched.add(createCallback<InteractorEvent>(this.customFunctionForOnButtonPinched,
